...
#ipmitool -I lanplus -H 192.168.2.21 -U admin -P Password1 raw 0x30 0x09 0x03 0x01, on

cmd="ipmitool -I lanplus -H 192.168.2.231 -U admin -P Password1 "
...
echo
echo "Disable SUT Board STBY"
echo
$cmd raw 0x30 0x09 0x03 0x00
...
echo
echo "Enable SUT Board STBY"
echo
$cmd raw 0x30 0x09 0x03 0x01
...
while true
do
	ping $os_ip_1 -c 15 2> /dev/null 1> ping_os_1.log
...
if [ "$os_ip_2" != "" ]; then
	...
	while true
	do
		ping $os_ip_2 -c 15 2> /dev/null 1> ping_os_2.log

...
res="curl -k -L -X GET 'https://$ip/api/host_inventory/host_interface_storage_info' -H 'Content-Type: application/json' -H 'Cookie: QSESSIONID=$session' -H 'X-CSRFTOKEN: $token'"
